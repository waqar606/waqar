      ...
      >
        {video ? (
          <video
            ...
            muted
            playsInline
            className="w-auto h-60 object-fill" // Increased height for video
          />
        ) : (
          image && (
            <Image
              ...
              alt={title}
              width={500}
              height={400} // Increased height for image
              className="h-60 w-full overflow-hidden object-fil object-top" // Adjusted height for image
            />
          )
        )}
      </Link>
